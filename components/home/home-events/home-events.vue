  ...
  <section>
    <u-container>
      <div class="py-24 sm:py-32">
        ...
        <div class="mt-16 max-w-2xl ml-5">
          <ol class="relative border-s border-gray-200 dark:border-gray-700">
            <li class="mb-10 ms-6">
              <span class="absolute flex items-center justify-center w-6 h-6 bg-red-100 rounded-full -start-3 ring-8 ring-gray-50 dark:ring-gray-900 dark:bg-blue-900">
                <svg
                  class="w-2.5 h-2.5 text-red-800 dark:text-blue-300"
                  aria-hidden="true"
            ...
            <li class="mb-10 ms-6">
              <span class="absolute flex items-center justify-center w-6 h-6 bg-red-50 rounded-full -start-3 ring-8 ring-gray-50 dark:ring-gray-900 dark:bg-blue-900">
                <svg
                  class="w-2.5 h-2.5 text-red-800 dark:text-blue-300"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
